-- Segmentation Analysis for education
CREATE OR REPLACE VIEW vw_segment_education AS
SELECT
  st.education,                   
  r.campaign_no,                  
  r.accepted,                    
...
GROUP BY st.education, r.campaign_no, r.accepted
ORDER BY st.education, r.campaign_no, r.accepted;
